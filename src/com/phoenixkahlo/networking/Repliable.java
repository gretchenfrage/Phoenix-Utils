...
/**
 * Represents a Sendable that can be replied to, so long as both sides of the connection support replies.
 ...
 */
public interface Repliable<A, B> extends Sendable<A, B> {

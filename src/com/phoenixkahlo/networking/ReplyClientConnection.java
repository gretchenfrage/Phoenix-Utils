...
/**
 * A ClientConnection that allows for replies.
 ...
 */
public class ReplyClientConnection<A, B> extends ClientConnection<A, B> {
	...
	public ReplyClientConnection(Socket socket, SendableCoder<A, B> coder) {
		super(socket, coder);
	}
